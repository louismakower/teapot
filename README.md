...
2. Copy the files inside `pico_scripts` to a workspace.
...
5. Save the script on the pico, making sure it is saved as `main.py.`  In VSCode, this is done by right-clicking the file and selecting **Upload File to Pico**.
6. Save the display script, making sure it is saved as `display.py`.
